    ...
    return [...sources].sort((a, b) => {
      ...
      switch (sortKey) {
        ...
        case "lastPaymentDate":
          // nullは最後にソート
          if (a.lastPaymentDate === null && b.lastPaymentDate === null) comparison = 0;
            ...
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-right">
                  <button
                    type="button"
                    className="flex w-full items-center justify-end hover:text-foreground"
                ...
                <TableRow key={source.id}>
                  <TableCell>
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => handleSelectOne(source.id, checked as boolean)}
                    />
                  </TableCell>
                  <TableCell className="font-medium">
                    <Link href={buildDetailLink(source.id, currentFilter)} className="text-primary hover:underline">
                      {source.name}
                    </Link>
                  </TableCell>
                  <TableCell>
                    <Select
                      ...
                      onValueChange={(value) => handleCategoryChange(source.id, value)}
                      disabled={isPending}
                    >
                      <SelectTrigger className="w-[150px]">
                        <SelectValue>
