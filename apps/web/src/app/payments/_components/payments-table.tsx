    ...
    <Card>
      <CardContent className="p-0">
            ...
            <TableBody>
              {payments.map((payment) => (
                <TableRow key={payment.id}>
                  <TableCell className="font-mono text-sm">{formatDate(payment.paymentDate)}</TableCell>
        ...
        <div className="flex items-center justify-between border-t p-4">
          <span className="text-sm text-muted-foreground">{payments.length}件の支払い</span>
          <div className="text-right">
            <span className="mr-2 text-sm text-muted-foreground">合計:</span>
